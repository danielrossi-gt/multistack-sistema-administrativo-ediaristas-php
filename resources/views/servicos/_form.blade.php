                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="icone" id="icone" class="form-control">
                            <option value="">Selecione o ícone</options>
                            <option value="twf-cleaning-1" {{ isset($servico) && $servico->icone === 'twf-cleaning-1' ? 'selected' : '' }}>Ícone 1</options>
                            <option value="twf-cleaning-2" {{ isset($servico) && $servico->icone === 'twf-cleaning-2' ? 'selected' : '' }}>Ícone 2</options>
                            <option value="twf-cleaning-3" {{ isset($servico) && $servico->icone === 'twf-cleaning-3' ? 'selected' : '' }}>Ícone 3</options>
                        </select>                   
                    </div>
                </div>
                <div class="col-md-4">
